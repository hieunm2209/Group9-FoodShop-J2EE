...
@WebServlet(urlPatterns = { "/userInfoCustomer" })
public class userInfoCustomerServlet extends HttpServlet{
	...
	private static final long serialVersionUID = 1L;
	 ...
	 public userInfoCustomerServlet() {
	      super();
	  }
	  ...
	  protected void doGet(HttpServletRequest request, HttpServletResponse response)
	      ...
	      RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/userInfoCustomerView.jsp");
