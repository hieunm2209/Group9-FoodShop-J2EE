...
@WebServlet(urlPatterns = { "/manageArticle"})
	...
	@Override
	   ...
	   protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Connection conn = MyUtils.getStoredConnection(request);
	      ...
	      try {
	          list = DBUtils.getAllArtical(conn);
	      ...
	      request.setAttribute("articallist",list);
	       RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/manageArticleView.jsp");
